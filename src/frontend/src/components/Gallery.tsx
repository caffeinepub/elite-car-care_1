    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          >
            Every vehicle tells a story. Here's a glimpse of the transformations
            we've delivered.
          </p>
        </ScrollReveal>
      ...
      {lightbox !== null && (
        ...
        >
          ...
          />
          <div
            className="absolute bottom-6 left-1/2 -translate-x-1/2 px-4 py-2 text-sm font-semibold tracking-widest uppercase z-10"
            style={{ color: "oklch(0.78 0.14 85)" }}
          >
