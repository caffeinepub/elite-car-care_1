    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <span
            style={{
              background: 'linear-gradient(135deg, oklch(0.85 0.12 88), oklch(0.78 0.14 85), oklch(0.65 0.13 82))',
        ...
        >
          We treat every vehicle like our own — delivering showroom-quality results
          with professional-grade products and meticulous attention to detail.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button onClick={handleBookNow} className="btn-gold min-w-[180px]">
            Book Now
          </button>
          <button onClick={handleLearnMore} className="btn-outline-gold min-w-[180px]">
            Our Services
          </button>
        </div>
        ...
        {/* Stats */}
        <div
          className="mt-16 grid grid-cols-3 gap-8 max-w-lg mx-auto pt-12"
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="text-xs tracking-widest uppercase" style={{ color: 'oklch(0.55 0 0)' }}>
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        <div className="text-xs tracking-widest uppercase" style={{ color: 'oklch(0.5 0 0)' }}>
          Scroll
        </div>
        <div
          className="w-px h-8"
          style={{ background: 'linear-gradient(to bottom, oklch(0.78 0.14 85), transparent)' }}
        />
      </div>
    </section>
  );
