...
const highlights = [
  {
    ...
    description:
      'Our certified detailers bring over a decade of hands-on experience with all vehicle types — from daily drivers to exotic supercars.',
  },
  {
    icon: Package,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent, oklch(0.78 0.14 85 / 0.3), transparent)' }}
      />
      <div
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <ScrollReveal>
            ...
            />
            <p className="text-base leading-relaxed mb-8" style={{ color: 'oklch(0.6 0 0)' }}>
              At Elite Car Care, we don't just clean cars — we restore them to their finest form.
              Our commitment to excellence, premium materials, and customer satisfaction sets us apart
