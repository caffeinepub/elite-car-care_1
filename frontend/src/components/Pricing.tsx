...
const plans = [
  {
    ...
    price: '$79',
    period: 'per service',
    description: 'Perfect for regular maintenance and keeping your car looking its best.',
    features: [
      'Exterior hand wash',
      'Wheel & tire cleaning',
      'Window cleaning',
  ...
  },
  {
    ...
    price: '$299',
    period: 'per service',
    description: 'The ultimate detailing experience — showroom quality, guaranteed.',
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="mt-6 text-base max-w-xl mx-auto" style={{ color: 'oklch(0.6 0 0)' }}>
            No hidden fees. No surprises. Just exceptional results at fair prices.
          </p>
        </ScrollReveal>
          ...
          {plans.map((plan, i) => (
            <ScrollReveal key={plan.name} delay={i * 100}>
              <div
                ...
                style={{
                  backgroundColor: plan.highlighted ? 'oklch(0.15 0 0)' : 'oklch(0.13 0 0)',
                  border: plan.highlighted
                    ? '2px solid oklch(0.78 0.14 85)'
                    : '1px solid oklch(0.25 0 0)',
                  borderRadius: '4px',
                  boxShadow: plan.highlighted ? '0 0 40px oklch(0.78 0.14 85 / 0.15)' : 'none',
                }}
              >
                {/* Badge */}
                {plan.badge && (
                ...
                <div
                  ...
                  style={{ color: plan.highlighted ? 'oklch(0.78 0.14 85)' : 'oklch(0.55 0 0)' }}
                >
                  {plan.name}
                </div>
                ...
                <p className="text-sm mb-6 leading-relaxed" style={{ color: 'oklch(0.6 0 0)' }}>
                  {plan.description}
                </p>
                ...
                <ul className="flex-1 space-y-3 mb-8">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      ...
                      />
                      <span className="text-sm" style={{ color: 'oklch(0.7 0 0)' }}>
                        {feature}
                      </span>
                    </li>
                  ))}
                ...
                <button
                  onClick={handleBook}
                  className={plan.highlighted ? 'btn-gold w-full' : 'btn-outline-gold w-full'}
                >
                  {plan.cta}
                </button>
              </div>
        ...
        {/* Note */}
        <ScrollReveal>
          <p className="text-center text-sm mt-8" style={{ color: 'oklch(0.45 0 0)' }}>
