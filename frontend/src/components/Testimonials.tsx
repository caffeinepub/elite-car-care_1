...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-24 px-4 sm:px-6" style={{ backgroundColor: 'oklch(0.1 0 0)' }}>
          ...
          {testimonials.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 80}>
              <div
                ...
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLDivElement).style.borderColor = 'oklch(0.22 0 0)';
                }}
              >
                {/* Quote icon */}
                <Quote
                ...
                >
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, oklch(0.78 0.14 85 / 0.2), oklch(0.65 0.13 82 / 0.2))',
