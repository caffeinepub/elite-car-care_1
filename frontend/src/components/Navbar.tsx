    ...
    <>
      <nav
        ...
        style={{
          ...
          borderBottom: scrolled ? '1px solid oklch(0.78 0.14 85 / 0.15)' : 'none',
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            <div
              ...
              style={{ background: 'linear-gradient(135deg, oklch(0.78 0.14 85), oklch(0.65 0.13 82))' }}
            >
            ...
            {navLinks.map((link) => (
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.backgroundColor = 'oklch(0.78 0.14 85 / 0.08)';
                }}
                onMouseLeave={(e) => {
